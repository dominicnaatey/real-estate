...
export const properties: Property[] = [
  {
    ...
    coordinates: { lat: 34.1002, lng: -118.4595 },
  ...
  },
  {
    ...
    description: "A historic mansion with classic southern charm, currently archived for maintenance review.",
    highlights: defaultHighlights,
    features: defaultFeatures,
    amenities: ["Historic", "Oak Trees", "Grand Hall"],
    agent: {
      name: "Johnathan Wick",
      role: "Senior Associate",
  ...
  },
  {
    ...
    description: "A beautiful coastal property with direct beach access, archived due to contract expiration.",
    highlights: defaultHighlights,
    features: defaultFeatures,
    amenities: ["Ocean Front", "Beach Access", "Modern Design"],
    agent: {
      name: "Johnathan Wick",
      role: "Senior Associate",
      image: "https://lh3.googleusercontent.com/aida-public/AB6AXuD6VjvKduUMIpVRQS_sAquIACrsXp7oEijk7uGzJpKTelxOHGbMcpGPpodPuzQHsLIvfwvYcYE2UB51yQElUrvBgDjesu6kCMBZRgHE01Q_eG5SWSl0x38TL-ygNBqortAJ8zwbTwWTRZRkG71S6xgQDWql_LJjSy4BEpF-ikoEM5G_E3dPVkr9nqp_9XP6epqUgWjojGFnzPhgRV642WLTBnUwcxJtu41pRFRdYRSA1l1YuH5jT0Hvc4Quzm8TKqnJBJdn-m_vQy8q",
  ...
  },
  {
    ...
    coordinates: { lat: 34.1177, lng: -118.352 },
    listingType: "For Rent",
    isFeatured: false,
    price: 2600,
    beds: 4,
  ...
  },
  {
    ...
    coordinates: { lat: 34.0753, lng: -118.3829 },
    listingType: "For Rent",
    isFeatured: false,
    price: 5000,
    beds: 3,
