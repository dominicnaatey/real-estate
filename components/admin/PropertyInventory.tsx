...
export function PropertyInventory() {
  return (
    <section className="lg:col-span-2 bg-white rounded-2xl border-admin border-admin-border hover:shadow-admin-card-hover transition-shadow duration-300 overflow-hidden">
      ...
      <div className="overflow-x-auto p-5">
        <table className="w-full text-left">
          <thead>
            <tr className="text-[#3e4944] text-[11px] uppercase tracking-wider border-b-admin border-admin-border font-semibold">
