...
export function StatsGrid() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      <div className="bg-white p-6 md:p-8 rounded-2xl border border-slate-200/70 shadow-sm transition-transform hover:scale-[1.01] duration-200">
        ...
        <h3 className="text-3xl font-extrabold text-slate-900">148</h3>
      </div>
      ...
      <div className="bg-white p-6 md:p-8 rounded-2xl border border-slate-200/70 shadow-sm transition-transform hover:scale-[1.01] duration-200">
        ...
        <h3 className="text-3xl font-extrabold text-slate-900">$2.4M</h3>
      </div>
    </div>
  );
}
