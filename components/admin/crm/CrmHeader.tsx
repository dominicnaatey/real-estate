  ...
  return (
    <div className="flex items-end justify-between mb-8">
      ...
      <div className="flex gap-3">
        <button
          type="button"
          className="px-4 py-2 border border-admin-border bg-white rounded text-[11px] font-semibold uppercase tracking-wider text-[#3e4944] hover:bg-[#F0F5F0] transition-colors flex items-center gap-2"
        >
