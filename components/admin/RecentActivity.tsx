export function RecentActivity() {
  return (
    <section className="lg:col-span-1 bg-white rounded-2xl border border-gray-200 p-5 hover:shadow-[0_4px_20px_rgba(0,0,0,0.05)] transition-shadow duration-300">
