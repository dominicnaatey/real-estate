...
export function DashboardLeadConversion() {
  ...
  return (
    <div className="bg-white rounded-2xl border-admin border-admin-border p-5 hover:shadow-admin-card-hover transition-shadow duration-300 flex flex-col items-center justify-center relative overflow-hidden">
