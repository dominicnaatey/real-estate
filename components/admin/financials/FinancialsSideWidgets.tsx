      ...
      <div className="bg-white border border-admin-border rounded-2xl p-5">
        ...
        <form className="space-y-3">
          <div>
            ...
            <select className="w-full border border-admin-border rounded p-2 text-sm text-[#181d1a] bg-white focus:ring-1 focus:ring-[#008060] outline-none">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                className="w-full border border-admin-border rounded py-2 pl-7 pr-3 text-sm text-[#181d1a] focus:ring-1 focus:ring-[#008060] outline-none"
                placeholder="0.00"
                type="text"
              />
            </div>
          ...
          <button
            className="w-full bg-[#F9FAFB] border border-admin-border text-[#181d1a] rounded py-2 text-sm font-medium hover:bg-[#F0F5F0] transition-colors"
            type="button"
          >
            Generate Draft
          </button>
