...
export function DashboardRecentProperties() {
  ...
  return (
    <div className="bg-white rounded-2xl border-admin border-admin-border hover:shadow-admin-card-hover transition-shadow duration-300 overflow-hidden flex flex-col">
      <div className="p-5 border-b-admin border-admin-border flex justify-between items-center">
        ...
        <table className="w-full text-left border-collapse">
          ...
          <tbody className="text-[13px]">
            {rows.map((row) => (
              <tr
                key={row.id}
                className="border-b-admin border-admin-border hover:bg-[#F9FAFB] transition-colors"
              >
      ...
      <div className="p-3 border-t-admin border-admin-border bg-white flex items-center justify-between text-[13px] text-[#3e4944]">
        <span>Showing 1 to 3 of 84 entries</span>
        <div className="flex gap-1">
          <button
            type="button"
            className="px-2 py-1 rounded border-admin border-admin-border hover:bg-[#F0F5F0] disabled:opacity-50"
            disabled
          ...
          <button
            type="button"
            className="px-3 py-1 rounded border-admin border-admin-border hover:bg-[#F0F5F0]"
            aria-label="Page 2"
          >
            2
          </button>
          ...
          <button
            type="button"
            className="px-2 py-1 rounded border-admin border-admin-border hover:bg-[#F0F5F0]"
