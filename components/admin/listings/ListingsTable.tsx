    ...
    <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
      ...
      <div className="p-4 border-t border-gray-200 flex items-center justify-between bg-white">
        ...
        <div className="flex gap-1">
          <button
            className="px-3 py-1 border border-gray-200 rounded text-[#3e4944] hover:bg-[#F9FAFB] text-sm disabled:opacity-50"
            disabled
            type="button"
          >
            Prev
          ...
          <button
            className="px-3 py-1 border border-gray-200 rounded text-[#3e4944] hover:bg-[#F9FAFB] text-sm"
            type="button"
          >
            2
          </button>
