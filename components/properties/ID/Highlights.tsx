      ...
      <div className="border border-gray-200 rounded-2xl p-6">
        <div className="grid grid-cols-2 md:grid-cols-3 gap-y-8 gap-x-4">
          ...
          <div className="flex items-start gap-3">
            <Home className="text-gray-600 mt-0.5" size={20} />
            <div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-sm font-medium text-gray-600 mb-1">Building Year</p>
              <p className="text-base font-semibold text-gray-900">{buildingYear}</p>
            </div>
          </div>
          {/* outside */}
          <div className="flex items-start gap-3">
            <View className="text-gray-600 mt-0.5" size={20} />
            <div>
              <p className="text-sm font-medium text-gray-600 mb-1">Outside</p>
              <p className="text-base font-semibold text-gray-900">{outside}</p>
            </div>
          </div>
          {/* garden */}
          <div className="flex items-start gap-3">
            <TreePine className="text-gray-600 mt-0.5" size={20} />
            <div>
              <p className="text-sm font-medium text-gray-600 mb-1">Garden</p>
              <p className="text-base font-semibold text-gray-900">{garden}</p>
            </div>
          </div>
          {/* parking */}
          <div className="flex items-start gap-3">
            <SquareParking className="text-gray-600 mt-0.5" size={20} />
            <div>
